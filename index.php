...
<div id="header_img">
    <img src="media/icons/header.png" alt="header">
    <a href="start/klerenKiezen.php"><button class="button6" >Aan de slag!</button></a>
</div>

<div class="navbar">
    <img src="media/icons/logo_drescode_wit.png" alt="logo" class="logo" id="logo_drescode_wit">
...
<div class="vakje2">
    ...
    <a href="start/gallery.php"><button class="button2">Showpagina</button></a>

</div>

<div class="vakje3">

    <button class="button3">Aanmelden</button>

    <p>Nog geen account registreer dan nu!</p>


    <button class="button4 button-gradient">Registreren</button>

</div>

<div class="vakje4">

    <a href="start/klerenKiezen.php"><button class="button5">Meteen starten</button></a>
...
<div id="footer_img">
    ...
    <img src="media/icons/footer.png" alt="header">
...
<div class="icons">
    ...
    <div class="ticons">
        <img class="instagram" src="data:image/png;base64,">
